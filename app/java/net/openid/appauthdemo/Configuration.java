...
public final class Configuration {
    ...
    private void readConfiguration() throws InvalidConfigurationException {
        ...
        Log.e("--->mConfigHash", String.valueOf(mConfigHash));
        Log.e("--->mClientId", String.valueOf(mClientId));
        Log.e("--->mScope", String.valueOf(mScope));
        Log.e("--->mRedirectUri", String.valueOf(mRedirectUri));
        Log.e("--->mUserInfoEndUri", String.valueOf(mUserInfoEndpointUri));
    }
